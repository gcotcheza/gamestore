    ...
    <div class="container">
        <div class="row mb-4 mt-5">
            <div class="d-flex">
                ...
                <i class="fa fa-fire fa-3x text-warning ms-1" aria-hidden="true"></i>
            </div>
        </div>
        ...
        <div class="coming-soon-list">
            <div class="row">
                <div class="col-lg-6 mb-4">
                    <div class="card h-100 align-items-stretch bg-secondary rounded-3 text-light mb-3">
                        <div class="row g-0">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title lh-base p-3">Star Ocean: The Second Story R</h5>
                                    <p class="card-text">Fantasy and Science Fiction collide in a unique visual style!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card h-100 align-items-stretch bg-secondary rounded-3 text-light mb-3">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{ asset('img/avatar_1.jpg') }}" class="img-fluid img-coming-soon rounded-start"
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title lh-base p-3">Avatar: Frontiers of Pandora</h5>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100 align-items-stretch bg-secondary rounded-3 text-light mb-3">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('img/prince_of_persia.jpg') }}"
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title lh-base p-3">Prince of Persia: The Lost Crown</h5>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100 align-items-stretch bg-secondary rounded-3 text-light mb-3">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('img/final_fantasy_cover.jpg') }}"
                                        class="img-fluid img-coming-soon rounded-start"
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title lh-base p-3">Final Fantasy VII Rebirth - Deluxe</h5>
                                        <p class="card-text">The Unknown Journey Continues... After escaping from
                                            the dystopian city
                                            of
                                            Midgar,
                                            Cloud and his friends set out on a journey across the planet. New
                                            adventures
                                            await
                                            in a vibrant and vast world – sprint across grassy plains on a Chocobo
                                            and
                                            explore
                                            expansive environments</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title lh-base p-3">Marvel’s Spider-Man 2</h5>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100 align-items-stretch bg-secondary rounded-3 text-light mb-3">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('img/robocop.jpeg') }}"
                                        class="img-fluid rounded-start img-coming-soon" alt="RoboCop Rogue City">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <span
                                        ...
                                        <h5 class="card-title lh-base p-3">RoboCop Rogue City</h5>
                                        <p class="card-text">Armed with your trusty Auto-9, factory-built strength, years
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100 align-items-stretch bg-secondary rounded-3 text-light mb-3">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('img/yohanne.webp') }}"
                                        class="img-fluid rounded-start img-coming-soon" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <span
                                        ...
                                        <h5 class="card-title lh-base p-3">Yohane the Parhelion: Blaze in the Deepblue</h5>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title lh-base p-3">Cities: Skylines II - Day 1 Edition</h5>
                                        <p class="card-text">Pre-order today and set your City apart with 9 Unique
                                            Buildings
                                            based on famous
